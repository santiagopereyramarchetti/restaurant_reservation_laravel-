                ...
                <div class="space-y-8 divide-y divide-gray-200 mt-10">
                    <form action="{{ route('admin.menues.update', $menue->id)}}" method="POST" enctype="multipart/form-data" class="space-y-8 mt-10">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="{{$menue->name}}" type="text" name="name" id="name" class="p-2 block w-full transition duration-150 ease-in-out bg-white border border-gray-400 rounded @error('name') border-red-600 @enderror">
                            </div>
                            @error('name')
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="{{ $menue->price }}" type="number" min="0.00" max="1000000.00" step="0.01" name="price" id="price" class="p-2 block w-full transition duration-150 ease-in-out bg-white border border-gray-400 rounded @error('price') border-red-600 @enderror">
                            </div>
                            @error('price')
                                <div class="text-red-600 mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea type="text" name="description" id="description" class="block w-full transition duration-150 ease-in-out bg-white border border-gray-400 rounded @error('description') border-red-600 @enderror">{{ $menue->description }}</textarea>
                            </div>
                            @error('description')
                                <div class="text-red-600 mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <select multiple type="text" name="categories[]" id="description" class="block w-full transition duration-150 ease-in-out bg-white border border-gray-400 rounded @error('categories') border-red-600 @enderror">
