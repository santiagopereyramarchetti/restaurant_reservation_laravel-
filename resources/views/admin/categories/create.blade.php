        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 mt-5 p-2 bg-slate-100 rounded w-1/2">
                <div class="space-y-8 divide-y divide-gray-200 mt-10">
                    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="space-y-8 mt-10">
                        @csrf
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea type="text" name="description" id="description" class="block w-full transition duration-150 ease-in-out bg-white border border-gray-400 rounded"></textarea>
                            </div>
                        </div>
                        <div class="mt-5 p-4">
